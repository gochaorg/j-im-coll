...
Наличие мутирующих методов, таких как `add` / `remove` в коллекциях как `java.util.List` или [Google guava](https://guava.dev/releases/23.0/api/docs/com/google/common/collect/ImmutableList.html) - 
